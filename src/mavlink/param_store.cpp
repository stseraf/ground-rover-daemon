...
ParamStore::ParamStore()
{
    ...
    params_[5] = {"VIDEO_FPS",       30.0f};
    params_[6] = {"NET_LINK_PREF",   0.0f};  // 0=auto, 1=WiFi-prefer, 2=LTE-force
    params_[7] = {"NET_LOG_STEP_MB", 10.0f}; // 0=disabled; MB between session-traffic logs
    // Per-mode bitrates (bps). Defaults tuned for 640×480 / 1296×972 / 1920×1080 / 2592×1944.
    params_[8]  = {"VIDEO_BITRATE_1", 1500000.0f};
    params_[9]  = {"VIDEO_BITRATE_2", 3000000.0f};
    params_[10] = {"VIDEO_BITRATE_3", 5000000.0f};
    params_[11] = {"VIDEO_BITRATE_4", 8000000.0f};
    // Video transport: 0=RTSP server (clients pull), 1=UDP push (rover→QGC).
    // Switching at runtime restarts the active backend.
    params_[12] = {"VIDEO_TRANSPORT", 0.0f};
