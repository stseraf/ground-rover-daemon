...
ParamStore::ParamStore()
{
    ...
    params_[5] = {"VIDEO_BITRATE",   5000000.0f}; // deprecated — superseded by VIDEO_BITRATE_N
    ...
    params_[9]  = {"VIDEO_BITRATE_1", 1500000.0f};
    params_[10] = {"VIDEO_BITRATE_2", 3000000.0f};
    params_[11] = {"VIDEO_BITRATE_3", 5000000.0f};
    params_[12] = {"VIDEO_BITRATE_4", 8000000.0f};
